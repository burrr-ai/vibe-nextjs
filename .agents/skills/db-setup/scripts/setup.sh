...
cp .agents/skills/db-setup/assets/db-index.ts src/server/db/index.ts
cp .agents/skills/db-setup/assets/schema.ts src/server/db/schema.ts
cp .agents/skills/db-setup/assets/drizzle.config.ts drizzle.config.ts
